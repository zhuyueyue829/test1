...
let bodyParser = require('body-parser');//专门处理post请求的请求体,拿到一个对象
let app = express();

app.use(function(req,res,next){//设置响应头
  res.header('Access-Control-Allow-Origin',"http://localhost:3000");//来源的域名和端口号，要设置前端允许的端口
